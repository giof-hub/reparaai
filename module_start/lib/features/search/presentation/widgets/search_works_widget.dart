...
class SearchWorks extends StatelessWidget {
  ...
  const SearchWorks({super.key, required this.work});
      ...
      child: Column(
        ...
        children: [
          ClipRRect(
            ...
            child: AssetGenImage(work.pathName).toImage(height: 160, width: double.infinity, fit: BoxFit.cover)
          ),
          Padding(
  ...
  List<Widget> getReviews(SearchEntity work) {
    List<Widget> reviews = [];
